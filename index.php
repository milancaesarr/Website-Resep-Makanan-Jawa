...
// Jika user sudah login, redirect ke halaman yang sesuai berdasarkan role
...
// Get community stats for preview
...
<head>
  ...
  <style>
    ...
    .community-preview {
      background: linear-gradient(135deg, var(--tripleColor), var(--doubleColor));
      padding: 80px 20px;
      margin-top: 50px;
      color: var(--white);
    }
    ...
    .contact-preview {
      background: linear-gradient(135deg, var(--doubleColor), var(--tripleColor));
      padding: 80px 20px;
      margin-top: 50px;
      color: var(--white);
    }
...
<body>
    ...
    <div class="slides">
      <div class="slide">
        ...
        <div class="content">
          ...
          <button class="banner" onclick="showLoginModal()" data-i18n="btn_visit">Login untuk Lihat</button>
        </div>
      </div>
      <div class="slide">
    ...
    <div class="about-content">
      <div class="about-left">
        ...
        <div class="about-text">
          ...
          <center><button onclick="showLoginModal()" data-i18n="btn_learn">Login untuk Lihat</button></center>
        </div>
      </div>
  ...
  <center>
    <section class="hero">
      ...
      <div class="hero-content">
        ...
        <p style="text-align: center; margin: 20px 0; font-weight: 600; color: var(--accentColor);">
          Login untuk mengakses semua resep dan fitur belanja
        </p>
        <div class="search-bar">
          <input type="text" id="searchInput2" placeholder="Login untuk mencari resep..." disabled data-i18n-placeholder="search_placeholder">
          <button id="searchBtn" aria-label="search" onclick="showLoginModal()">
        ...
        <!-- BAGIAN RESEP PREVIEW (TERBATAS) -->
        <div class="container-resep">
          <?php if ($recipe_result && mysqli_num_rows($recipe_result) > 0): ?>
            <?php
            $count = 0;
            while ($recipe = mysqli_fetch_assoc($recipe_result) && $count < 3):
            ?>
              <div class="card mix <?php echo strtolower(str_replace(' ', '-', $recipe['region'] ?? '')); ?>">
                ...
                <div class="card-content">
                  ...
                  <a href="#" onclick="showLoginModal(); return false;" class="lihat-btn">Login untuk Lihat</a>
                </div>
              </div>
            <?php
            $count++;
        ...
        <div class="lihat-semua-container">
          <a href="#" onclick="showLoginModal(); return false;" class="lihat-semua-btn" data-i18n="btn_lihat_semua">Login untuk Lihat Semua <i
  ...
  <!-- Product Section with Grid Layout - Login Required -->
  <section class="produk">
    <div class="container-produk">
        ...
        <h4 data-i18n="produk_slogan" style="text-align: center; margin: 30px 0; color: var(--secondaryColor);">
            Login untuk mengakses produk bumbu khas Nusantara!
        </h4>

        <div class="produk-grid-home">
            <?php
            // Preview produk (hanya 3 produk)
            if ($product_result && mysqli_num_rows($product_result) > 0) {
                mysqli_data_seek($product_result, 0);
                $count = 0;
                while (($product = mysqli_fetch_assoc($product_result)) && $count < 3):
            ?>
                    <div class="card-produk-home">
                        ...
                        <a href="#" onclick="showLoginModal(); return false;" class="lihat-produk-btn" data-i18n="btn_lihat_produk">
                            <i data-feather="eye"></i> Login untuk Lihat
                        </a>
                    </div>
            <?php
                    $count++;
            ...
            ?>
                <div style="grid-column: 1/-1; text-align: center; padding: 40px; color: var(--doubleColor);">
                    <p>Login untuk melihat produk yang tersedia.</p>
                    <button onclick="showLoginModal()" class="lihat-semua-btn">Login Sekarang</button>
                </div>
            <?php } ?>
        </div>

        <div class="lihat-semua-container">
            <a href="#" onclick="showLoginModal(); return false;" class="lihat-semua-btn" data-i18n="btn_lihat_semua">Login untuk Lihat Semua Produk <i
                data-feather="arrow-right"></i></a>
        </div>
    </div>
  </section>
  ...
  <section class="community-preview">
    <div class="community-container">
      ...
      <a href="#" onclick="showLoginModal(); return false;" class="community-cta">
    ...
    <div class="contact-container">
      <div class="contact-content">
        <div class="contact-info">
          ...
          <a href="#" onclick="showLoginModal(); return false;" class="community-cta" style="background: var(--light-brown); color: var(--accentColor); margin-top: 20px;">
            <i class="fas fa-arrow-right"></i>
            Login untuk Form Lengkap
          </a>
        </div>
        ...
        <div class="contact-form-preview">
          ...
          <form id="quickContactForm">
            <div class="form-group">
              ...
              <input type="text" id="quick_name" name="name" required placeholder="Login untuk menggunakan form">
            </div>

            <div class="form-group">
              <label for="quick_email">Email</label>
              <input type="email" id="quick_email" name="email" required placeholder="Login untuk menggunakan form">
            </div>

            <div class="form-group">
              <label for="quick_message">Pesan</label>
              <textarea id="quick_message" name="message" required placeholder="Login untuk menggunakan form"></textarea>
            </div>

            <div class="form-actions">
              <button type="button" onclick="showLoginModal()" class="btn-preview btn-primary">
                <i class="fas fa-sign-in-alt"></i>
                Login untuk Kirim
              </button>
              <a href="#" onclick="showLoginModal(); return false;" class="btn-preview btn-secondary">
  ...
  <div id="authModal" class="modal">
    <div class="modal-content">
      <div class="modal-header">
        <h2 id="modalTitle">Masuk ke Akun Anda</h2>
      ...
      <div class="modal-body">
        ...
        <div id="loginForm">
          <form id="loginFormElement">
            ...
            <button type="submit" class="btn-modal btn-primary-modal">Masuk</button>
          </form>
        ...
        <div id="registerForm" style="display: none;">
          <form id="registerFormElement">
            ...
            <button type="submit" class="btn-modal btn-primary-modal">Daftar</button>
          </form>
          <div class="switch-modal">
  ...
  <script>
    ...
    function showLogin() {
      document.getElementById('modalTitle').textContent = 'Masuk ke Akun Anda';
    ...
    document.getElementById('loginFormElement').addEventListener('submit', async function(e) {
      ...
      try {
        ...
        if (result.success) {
          ...
          setTimeout(() => {
            window.location.href = result.redirect || 'home-login.php';
          }, 1000);
        } else {
          showLogin();
    ...
    // Update cart count on page load for home page
